...
const CreditCardDesingTwo = () => {
  return (
    <View className="m-1 w-80 h-48 ">
      <ImageBackground
      ...
      >
        <View className="w-auto h-28 rounded-t-lg">
          <View className=" flex flex-row items-center justify-between">
            ...
            <View className="bg-teal-800 w-8 h-8 rounded-full justify-center items-center">
...
export default CreditCardDesingTwo;
